      ...
      {!isResultVisible &&
        <div className="container max-w-screen-lg mx-auto">
          <div>
            ...
            <p className="text-gray-700 mb-6">Please fill out all the fields regarding the location and soil data.</p>
            <div className="container rounded shadow-lg px-4 md:p-8 mb-6">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                ...
                <div className="lg:col-span-2">
                  <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                    ...
                    <div className="lg:col-span-2">
                      <div className="flex justify-end gap-5 py-5"> {/* Add this class to right-align the buttons */}
